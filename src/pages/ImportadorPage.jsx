...
// Services
// CORREÇÃO: Importamos a função de dropdown (array simples)
...
function ImportadorPage() {
  ...
  // CORREÇÃO CRÍTICA: 
  // Usamos getFuncionariosDropdown para obter uma LISTA (Array) e não um objeto paginado.
  // O processarPDFHolerites precisa iterar (loop) sobre essa lista.
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      // Agora 'funcionarios' é garantidamente um array (ou undefined, tratado pelo || [])
  ...
  // --- Renderização da Aba de Documentos ---
    ...
    if (status === 'processing') {
      return (
        <div className="loading-container">
          ...
          <h3>Processando inteligência de documentos... 🤖</h3>
        </div>
      );
    }
