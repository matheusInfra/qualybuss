...
function FuncionarioForm() {
  ...
  useEffect(() => {
    // Carrega bancos (fallback se o serviço retornar null)
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Remove campos virtuais que não vão para o banco na tabela funcionarios
      ...
      if (isEditMode) {
        ...
        const funcionarioId = novoFunc[0]?.id || novoFunc.id; // Suporta retorno array ou objeto
