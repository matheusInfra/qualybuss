 ...
 * Exportada para ser usada na interface se necessário
 */
...
export const calcularSaldoDia = (batidasDoDia, jornada) => {
  ...
  // 3. Calcula tempo previsto (Carga Horária)
  ...
  return {
    ...
    saldo,
    status,
    batidasFormatadas: horarios // Retorna ['08:00', '12:00'] para exibir
  };
};

/**
 * [NOVO] Função essencial para a tela de Tratamento Manual.
 * Recebe os inputs do modal (Ent1, Sai1, Ent2, Sai2) e simula batidas para recalcular.
 */
